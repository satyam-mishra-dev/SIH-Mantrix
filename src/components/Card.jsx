...
function Card() {
    ...
    const items = [
        { 
          ...
          description: "We believe every student deserves clarity in their career journey. With empathy, data, and guidance, Mantrix empowers learners to discover their best-fit paths and achieve more.",
        ...
        { 
          ...
          description: "From AI-powered career prediction to guided stream selection, Mantrix simplifies complex choices and delivers personalized recommendations students can trust.",
          image: `<svg width="100%" height="100%" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        { 
          ...
          description: "We bring students closer to industry experts, counselors, and guides who provide real insights, mentorship, and encouragement throughout their journey.",
          image: `<svg width="100%" height="100%" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        { 
          ...
          description: "Designed for every learner—urban or rural—Mantrix works across devices, supports multiple languages, and ensures guidance is never out of reach.",
          image: `<svg width="100%" height="100%" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
